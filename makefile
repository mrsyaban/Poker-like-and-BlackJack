...
ARRAYUTIL_FILES  = $(SOURCE_FOLDER)/ArrayUtil/ArrayUtil.cpp
...
CPP_FILES := $(MAIN_FILES) $(TABLE_FILES) $(POINT_FILES) $(PLAYER_FILES) $(IO_FILES) $(INVENTORYHOLDER_FILES) $(GAME_FILES) $(DECK_FILES) $(COMBO_FILES) $(CARD_FILES) $(ARRAYUTIL_FILES) $(ACTION_FILES) $(ABILITY_FILES)
