...
GAMEENGINE_FILES = $(SOURCE_FOLDER)/GameEngine/GameEngine.cpp
BJ_FILES = $(SOURCE_FOLDER)/Blackjack/Blackjack.cpp

CPP_FILES := $(MAIN_FILES) $(TABLE_FILES) $(POINT_FILES) $(PLAYER_FILES) $(IO_FILES) $(INVENTORYHOLDER_FILES) $(GAME_FILES) $(DECK_FILES) $(COMBO_FILES) $(CARD_FILES) $(ACTION_FILES) $(ABILITY_FILES) $(GAMEENGINE_FILES) $(BJ_FILES)
